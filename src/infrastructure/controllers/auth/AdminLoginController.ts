import { IAdminLoginUseCase } from '../../../application/use-cases/auth/interfaces/IAdminLoginUseCase';
import {
  IAdminLoginController,
  AdminLoginControllerInput,
  AdminLoginControllerOutput,
} from '../../../interfaces/controllers/IAdminLoginController';
