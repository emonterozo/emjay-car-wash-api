...
import {
  IGetAllCustomerParams,
  IGetAllCustomersUseCase,
} from '../../../application/use-cases/customers/interfaces/IGetAllCustomers';
import {
  CustomerOutput,
...
export class GetAllCustomersController implements IGetAllCustomersController {
  ...
  public async handle(
    token: string,
    params?: IGetAllCustomerParams,
  ): Promise<GetAllCustomersControllerOutput> {
