...
export class CreateTransactionController implements ICreateTransactionController {
    ...
    constructor(private readonly _create_transaction_usecase: CreateTransactionUseCase) { }

    public async handle(params: CreateTransactionControllerInput): Promise<ControllerResponse<{ success: boolean; }>> {
